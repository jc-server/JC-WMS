...
import {
  ...
  ChevronLeft, ChevronRight, Save, IndianRupee, Settings2,
} from 'lucide-react';
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <select value={editRole} onChange={(e) => setEditRole(e.target.value)} className="flex-1 px-3 py-2 bg-white dark:bg-zinc-900 text-slate-900 dark:text-white rounded-lg border border-slate-200 dark:border-zinc-700 focus:border-amber-400 outline-none text-sm">
